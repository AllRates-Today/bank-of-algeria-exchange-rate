'use strict';
// Bank of Algeria exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bda';
...
/** Latest rate for one pair, e.g. getRate('USD', 'DZD', { apiKey }). */
